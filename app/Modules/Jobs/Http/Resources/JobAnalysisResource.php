...
class JobAnalysisResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'years_experience_min' => $this->years_experience_min,
            'years_experience_max' => $this->years_experience_max,
            ...
            'timezone_hint' => $this->timezone_hint,
            'domain_tags' => $this->domain_tags ?? [],
            'tech_stack' => $this->tech_stack ?? [],
            'skill_categories' => $this->skill_categories ?? [],
