<template>
  <div class="space-y-6">
    <PageHeader
      eyebrow="Workspace"
      title="Settings"
      description="Manage reusable answer templates that feed cover letters and common application question drafts."
    />

    <ErrorState v-if="pageError" title="Settings unavailable" :message="pageError">
      <template #actions>
